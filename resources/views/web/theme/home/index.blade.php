                      ...
                      <form>
                         <div class="search-form">
                           ...
                           <div class="col-md-2 col-sm-3 col-xs-4">
                               <div class="box">
                                   <a href="#">
                                   <img alt="Convertible" src="https://templates.scriptsbundle.com/carspot/demos/images/bodytype/1.png">
                                   <h4>Convertible</h4>
                                   </a>
                               </div>
                           </div>
                           ...
                           <div class="col-md-2 col-sm-3 col-xs-4">
                               <div class="box">
                                   <a href="#">
                                   <img alt="Coupe" src="https://templates.scriptsbundle.com/carspot/demos/images/bodytype/2.png">
                                   <h4>Coupe</h4>
                                   </a>
                               </div>
                           </div>
                           ...
                           <div class="col-md-2 col-sm-3 col-xs-4">
                               <div class="box">
                                   <a href="#">
                                   <img alt="Sedan" src="https://templates.scriptsbundle.com/carspot/demos/images/bodytype/3.png">
                                   <h4>Sedan</h4>
                                   </a>
                               </div>
                           </div>
                           ...
                           <div class="col-md-2 col-sm-3 col-xs-4">
                               <div class="box">
                                   <a href="#">
                                   <img alt="Van/Minivan" src="https://templates.scriptsbundle.com/carspot/demos/images/bodytype/4.png">
                                   <h4>Van/Minivan</h4>
                                   </a>
                               </div>
                           </div>
                           ...
                           <div class="col-md-2 col-sm-3 col-xs-4">
                               <div class="box">
                                   <a href="#">
                                   <img alt="Truck" src="https://templates.scriptsbundle.com/carspot/demos/images/bodytype/5.png">
                                   <h4>Truck</h4>
                                   </a>
                               </div>
                           </div>
                           ...
                           <div class="col-md-2 col-sm-3 col-xs-4">
                               <div class="box">
                                   <a href="#">
                                   <img alt="Hybrid" src="https://templates.scriptsbundle.com/carspot/demos/images/bodytype/6.png">
                                   <h4>Hybrid</h4>
                                   </a>
                               </div>
                           </div>
                ...
                <div class="col-md-12 col-xs-12 col-sm-12">
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="https://templates.scriptsbundle.com/carspot/demos/images/posting/2.jpg" class="img-responsive">
                         ...
                         <div class="short-description-1 clearfix">
                            ...
                            <h3><a title="" href="https://templates.scriptsbundle.com/carspot/demos/single-page-listing.html">Porsche 911 Carrera 2017 </a></h3>
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="https://templates.scriptsbundle.com/carspot/demos/images/posting/3.jpg" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                         ...
                         <div class="short-description-1 clearfix">
                            <div class="category-title"> <span><a href="#">Car & Bikes</a></span> </div>
                            <h3><a title="" href="https://templates.scriptsbundle.com/carspot/demos/single-page-listing.html">2014 Ford Shelby GT500 Coupe</a></h3>
                            <p class="location"><i class="fa fa-map-marker"></i> Model Town Link Road London</p>
                            <ul class="list-unstyled">
                               <li><a href="javascript:void(0)"><i class="flaticon-gas-station-1"></i>Diesel</a></li>
                               <li><a href="javascript:void(0)"><i class="flaticon-dashboard"></i>35,000 km</a></li>
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="https://templates.scriptsbundle.com/carspot/demos/images/posting/6.jpg" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                         ...
                         <div class="short-description-1 clearfix">
                            <div class="category-title"> <span><a href="#">Car & Bikes</a></span> </div>
                            <h3><a title="" href="https://templates.scriptsbundle.com/carspot/demos/single-page-listing.html">McLaren F1 Sports Car</a></h3>
                            <p class="location"><i class="fa fa-map-marker"></i> Model Town Link Road London</p>
                            <ul class="list-unstyled">
                               <li><a href="javascript:void(0)"><i class="flaticon-gas-station-1"></i>Diesel</a></li>
                               <li><a href="javascript:void(0)"><i class="flaticon-dashboard"></i>35,000 km</a></li>
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="https://templates.scriptsbundle.com/carspot/demos/images/posting/13.jpg" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                         ...
                         <div class="short-description-1 clearfix">
                            <div class="category-title"> <span><a href="#">Car & Bikes</a></span> </div>
                            <h3><a title="" href="https://templates.scriptsbundle.com/carspot/demos/single-page-listing.html">2017 Audi A4 quattro Premium</a></h3>
                            <p class="location"><i class="fa fa-map-marker"></i> Model Town Link Road London</p>
                            <ul class="list-unstyled">
                               <li><a href="javascript:void(0)"><i class="flaticon-gas-station-1"></i>Diesel</a></li>
                               <li><a href="javascript:void(0)"><i class="flaticon-dashboard"></i>35,000 km</a></li>
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="https://templates.scriptsbundle.com/carspot/demos/images/posting/14.jpg" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                         ...
                         <div class="short-description-1 clearfix">
                            <div class="category-title"> <span><a href="#">Car & Bikes</a></span> </div>
                            <h3><a title="" href="https://templates.scriptsbundle.com/carspot/demos/single-page-listing.html">Bugatti Veyron Super Sport </a></h3>
                            <p class="location"><i class="fa fa-map-marker"></i> Model Town Link Road London</p>
                            <ul class="list-unstyled">
                               <li><a href="javascript:void(0)"><i class="flaticon-gas-station-1"></i>Diesel</a></li>
                               <li><a href="javascript:void(0)"><i class="flaticon-dashboard"></i>35,000 km</a></li>
                   ...
                   <div class="col-md-4 col-xs-12 col-sm-6">
                      <div class="category-grid-box-1">
                         ...
                         <div class="image">
                            <img alt="Carspot" src="https://templates.scriptsbundle.com/carspot/demos/images/posting/8.jpg" class="img-responsive">
                            <div class="ribbon popular"></div>
                            <div class="price-tag">
                         ...
                         <div class="short-description-1 clearfix">
                            <div class="category-title"> <span><a href="#">Car & Bikes</a></span> </div>
                            <h3><a title="" href="https://templates.scriptsbundle.com/carspot/demos/single-page-listing.html">Honda Civic 2017 Sports Edition</a></h3>
                            <p class="location"><i class="fa fa-map-marker"></i> Model Town Link Road London</p>
                            <ul class="list-unstyled">
                               <li><a href="javascript:void(0)"><i class="flaticon-gas-station-1"></i>Diesel</a></li>
                               <li><a href="javascript:void(0)"><i class="flaticon-dashboard"></i>35,000 km</a></li>
          ...
          <div class="row clearfix">
             ...
             <div class="col-md-4 col-sm-12 col-xs-12">
                <figure class="wow zoomIn  animated" data-wow-delay="0ms" data-wow-duration="3500ms" >
                   <img class="center-block" src="https://templates.scriptsbundle.com/carspot/demos/images/service-car.png" alt="">
                </figure>
             </div>
          </div>
          ...
          <div class="row">
             <div class="owl-testimonial-2">
                ...
                <div class="single_testimonial">
                   ...
                   <div class="testimonial-meta-box">
                      <img src="https://templates.scriptsbundle.com/carspot/demos/images/users/2.jpg" alt="">
                      <div class="testimonial-meta">
       ...
       <div class="container">
          <div class="row">
             ...
             <div class="col-md-7 col-sm-12 col-xs-12">
                <div class="mainimage">
                   <a>
                      <img alt="" class="img-responsive" src="https://templates.scriptsbundle.com/carspot/demos/images/blog/1.jpg">
                      <div class="overlay">
             ...
             <div class="col-md-5 col-sm-12 col-xs-12">
                <div class="newslist">
                   <ul>
                      <li>
                         <div class="imghold"> <a><img src="https://templates.scriptsbundle.com/carspot/demos/images/blog/s1.jpg" alt=""></a> </div>
                         <div class="texthold">
                      ...
                      <li>
                         <div class="imghold"> <a><img src="https://templates.scriptsbundle.com/carspot/demos/images/blog/s2.jpg" alt=""></a> </div>
                         <div class="texthold">
                      ...
                      <li>
                         <div class="imghold"> <a><img src="https://templates.scriptsbundle.com/carspot/demos/images/blog/s3.jpg" alt=""></a> </div>
                         <div class="texthold">
                      ...
                      <li>
                         <div class="imghold"> <a><img src="https://templates.scriptsbundle.com/carspot/demos/images/blog/s4.jpg" alt=""></a> </div>
                         <div class="texthold">
                            <h4><a>Audi A4 Diesel Launched In India At Rs 40.20 Lakh </a></h4>
                            <p>Audi India has launched a powerful diesel variant of its A4 sedan at Rs 40.20 la...&nbsp;</p>
                         </div>
                ...
                <div class="brand-logo-area clients-bg">
                   <div class="clients-list">
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/16.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/2.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/11.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/4.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/5.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/6.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/7.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/8.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/9.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                      <div class="client-logo">
                         <a href="#"><img src="https://templates.scriptsbundle.com/carspot/demos/images/brands/17.png" class="img-responsive" alt="Brand Image" /></a>
                      </div>
                   </div>
                </div>
             </div>
          ...
          <div class="row">
             <div class="col-md-6 col-sm-6 col-xs-12 nopadding hidden-sm">
                <div class="call-to-action-img-section-right">
                   <img src="https://templates.scriptsbundle.com/carspot/demos/images/car-in-red.png" class="wow slideInLeft img-responsive" data-wow-delay="0ms" data-wow-duration="3000ms" alt="">
                </div>
             </div>
             ...
             <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <div class="sell-box-grid">
                   ...
                   <div class="text-center">
                      <img class="img-responsive wow slideInLeft center-block" data-wow-delay="0ms" data-wow-duration="2000ms" src="https://templates.scriptsbundle.com/carspot/demos/images/sell.png" alt="">
                   </div>
                </div>
             </div>
             <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                <div class="sell-box-grid">
                   ...
                   <div class="text-center">
                      <img class="img-responsive wow slideInRight center-block" data-wow-delay="0ms" data-wow-duration="2000ms" src="https://templates.scriptsbundle.com/carspot/demos/images/sell-1.png" alt="">
                   </div>
                </div>
             </div>
          </div>
